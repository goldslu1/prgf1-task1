...
public interface Circler {
    ...
    void drawCircle(Raster img, double x1, double y1, int color);

    default void drawCircle(Raster img, Point p1, int color){
        drawCircle(img, p1.x, p1.y, color);
    }

    default void drawCircle(Raster img, Circle circle, int color){
        drawCircle(img, circle.p1.x, circle.p1.y, color);
    }
}
